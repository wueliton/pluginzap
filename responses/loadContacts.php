...
if(isset($_POST['order'])) {
    if($_POST['order']=="BETWEEN") {
        ...
        $enterprise->listContacts($_SESSION['id_usuario'],$enterprisesList,$_POST['page'],10,"DESC",$_POST['between'],$_POST['andBetween']);
    }
    else {
        $enterprise->listContacts($_SESSION['id_usuario'],$enterprisesList,$_POST['page'],10,$_POST['order']);
    }
}
else {
    $enterprise->listContacts($_SESSION['id_usuario'],$enterprisesList,$_POST['page']);
}