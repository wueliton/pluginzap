...
$blog="";
$card="blog/images/como-adicionar-pluginzap-site.jpg";
include("../includes/headerBlog.php");
?>
<nav>
    <ul>
        <li>
            <a href="<?php echo $url?>"><img src="../source/images/logo.png" alt="PluginZap" /></a><a href="<?=$url?>blog/" class="blog">BLOG</a>
        </li>
        <ul>
...
<article>
    <div class="content">
        ...
        <div class="postDetails">
            <a href="#" class="category">PluginZap Ajuda</a> <span class="date"> Postado em <a href="#">28/07/2020</a></span>
        </div>
        <p>
            Desenvolvemos o PluginZap para tornar mais fácil receber contatos em seu Site, e não podiamos deixar de simplificar também a intergração com seu Site, para começar a utilizar seu script do PluginZap é preciso adicionar apenas
            uma linha de código nas páginas em que você deseja receber mensagens, e te ajudamos a realizar essa integração com as principais plataformas de Sites:
        </p>
        <h2>Adicionar ao meu Site HTML</h2>
        <p>
            Para adicionar seu Script do PluginZap em um Site desenvolvido em HTML, você precisará abrir todos os arquivos em que deseja receber mensagens e adicionar seu Script de Integração no fim de cada página, antes do fechamento da
            tag <code><&#47;body></code>.
        </p>
        <h3>Exemplo</h3>
        <p>
            Se eu desejo adicionar em minha página inicial <code>index.html</code>, é necessário abrir a página com um editor de texto (Bloco de Notas, Sublime Text, NotePad++) e identificar a tag <code><&#47;body></code>, o código deverá
            ser adicionado uma linha antes dessa tag:
        </p>
        ...
        <ol>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        Adicionar código as páginas: (Escolha as opções abaixo)
                        <ul>
                    ...
                    <li>
                        Coloque o código em: (Selecione a opção)
                        <ul>
                            <li>Body - fim</li>
                        </ul>
                    </li>
