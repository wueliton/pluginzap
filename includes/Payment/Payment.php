...
class Payment
{
    ...
    public function __construct()
    {
        ...
        $this->email = 'paulo.wueliton@hotmail.com'; // Seu e-mail de Login no PagSeguro
        $this->token = '83CAE4835F4445F6B1CE5DF858C8D2A8'; // Token da sua conta no PagSeguro
    }
     ...
     */
    public function createPlan($ref, $name, $period, $amount, $trial)
    {
    ...
    public function paymentRepeat($preApprovalCode, $document, $street, $number, $complement, $district, $city, $state, $country, $postalCode, $token, $holderName, $holderBirth, $holderPhone) {
        $this->action = "/pre-approvals/{$preApprovalCode}/payment-method";
        $this->params = [
            'type' => 'CREDITCARD',
            'sender' => [
                'ip' => '1.1.1.1',
    ...
    public function activateSignature($preApprovalCode) {
        $this->action = "/pre-approvals/{$preApprovalCode}/status";
        $this->params = [
            "status"=> "ACTIVE"
        ];
    ...
    public function cancelSignature($preApprovalCode) {
        $this->action = "/pre-approvals/{$preApprovalCode}/cancel";
        $this->params = "";
        $this->put();
    }
    ...
    {
        $this->action = "/pre-approvals/{$code}";
        $this->get();
    }
    ...
    {
        $this->action = "/pre-approvals/{$code}/payment-orders";
        $this->get();
    }
